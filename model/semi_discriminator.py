...
class DISCRIMINATOR(nn.Module):
    def __init__(self, modeltype, njoints, nfeats,
        ...
        self.latent_dim_body = 1 * 451 * 88 + 128 + 88*64
        self.latent_dim_hand = 1 * 690 * 88 + 128 + 88*64
    ...
    def forward(self, x_body_cp, x_body_p1_cp,x_hand_cp, x_handp1_cp, timesteps, y=None,uncond_info=False):
        ...
        xseq_body = torch.cat([x_body,embed_style_2_body,enc_text],axis=1)
        xseq_hand = torch.cat([x_hand,embed_style_2_hand,enc_text],axis=1)
